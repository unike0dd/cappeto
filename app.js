...
$('previewOwnerButton').addEventListener('click',async()=>{state.staff={id:'preview-owner',role:'owner',displayName:t('previewOwnerName'),preview:true};state.csrf='';showStaffControls(true);await loadCatalog();enterApp();switchView('manage')});
