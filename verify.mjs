...
for(const marker of ['authForm','productImage','productVat','productPurchaseDate','manageSearch','subtotal','vat','total','previousProduct','nextProduct','carouselPosition'])if(!html.includes(marker))throw new Error(`Missing UI marker: ${marker}`);
